        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url();?>">
                    <div class="inline"> My Project </div>
                </a>
        ...
        <div class="modal fade" id="editprofileModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="hidden" id="profile-role-id" value="<?=$this->session->userdata('user_id')?>"/>
                        <div class="row">
                             <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Name</label> &nbsp;&nbsp;
                                    <label class="error" id="erroredit_name"> field is required.</label>
                                    <label class="error" id="erroredit_name2"> name must be alphanumeric.</label>
                                    <input class="form-control" id="profile-name" placeholder="Name" name="name" type="text" value="<?=$this->session->userdata('name')?>" autofocus>
                                </div> 
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Email</label> &nbsp;&nbsp;
                                    <label class="error" id="erroredit_email"> field is required.</label>
                                    <label class="error" id="erroredit_email2"> email has already exist.</label>
                                    <label class="error" id="erroredit_email3"> invalid email adress.</label>
                                    <input class="form-control" id="profile-email" placeholder="E-mail" name="email" type="email" value="<?=$this->session->userdata('email')?>" autofocus>
                                </div> 
                            </div>
                      </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">CANCEL</button>
                        <button id="editprofileSubmit" onclick="update_user()" type="button" class="btn btn-primary">UPDATE</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
