                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-user-list">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" id="user-edit"  onclick="edit_user_popup('<?=$row->email?>','<?=$row->user_id?>','<?=$row->name?>','<?=$row->role?>','<?=$row->status?>');" data-toggle="modal" data-target="#editUser"> EDIT </a>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="role" id="role" class="form-control" >
                                        ...
                                        <?php foreach($roles as $con){  ?>
                                        <option value="<?=$con->role_name?>"><?=$con->role_name?> 
                                        </option>
                                    <?php } ?> 
                                    </select> 
                             ...
                             <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <label class="error" id="edit-error_pass"> field is required.</label>
                                  <input class="form-control" id="create-newPassword" placeholder="New Password" name="create-newPassword" type="text" autofocus>
                                </div>
                            </div>
                      </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="role_status_value" id="edit-status-id" value=""/>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Name</label> &nbsp;&nbsp;
                      ...
                      <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                  ...
                                  <input class="form-control" id="edit-newPassword" placeholder="New Password" name="edit-newPassword" type="text" autofocus>
                                </div>
                            </div>
                      </div>
                      <div class="row">
